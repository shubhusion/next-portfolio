...
const Skill = ({ name, image }: skill) => {
    ...
    const [bgColor, setBgColor] = useState('rgba(0, 0, 0, 0.07)'); // Default background color
    ...
    if (!isClient) {
        return <div className="h-20 w-20 md:h-24 md:w-24 rounded-full bg-gray-100 dark:bg-grey-800" />;
    }
